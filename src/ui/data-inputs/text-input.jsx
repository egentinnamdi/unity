    ...
    <div className={cn(containerClassname)}>
      ...
      >
        ...
        <input
          ...
          // type={"text"}
          className={cn(
            "text-themeText font-poppins h-14 w-full rounded-[10px] border bg-transparent py-3 text-left text-sm placeholder-gray-400 outline-none placeholder:font-medium placeholder:text-[#606060] focus:outline-none",
            inputClassName,
          )}
