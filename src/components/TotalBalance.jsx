...
function TotalBalance() {
  return (
    <Box className="flex-grow grid-cols-2 grid-rows-3 gap-y-10 p-7 lg:grid">
      <Box className="col-span-2 flex justify-center">
        <Box className="flex flex-col items-start justify-center space-y-2 rounded-xl border !p-5 !pl-16 capitalize lg:w-5/6">
          <Typography variant="h4">account number</Typography>
          <Typography variant="h4" className="!font-medium !text-gray-500">
            8157950762
          </Typography>
        </Box>
      </Box>
